...
init python:
    ...
    splash_message_default = "Эта не официальная фановая работа, сделанная без поддержки Team Salvato."
    splash_messages = [
    "Please support Doki Doki Literature Club & Team Salvato."
    "Ты мое солнце,\nМое единственое солнце",
    "Я скучала по тебе.",
    "Поиграй со мной",
    "Это просто игра, в основном.",
    "Эта игра не подходит для детей или легко впечатлительных людей?",
    "sdfasdklfgsdfgsgoinrfoenlvbd",
    "null",
    "Я даровала детям ад",
    "ПМ умер за это.",
    "Это была только частично твоя вина.",
    "Эта игра не подходит ни детям,ни тем, кто легко расчленяется..",
    "Не забывай делать резервную копию Моники."
    ]
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "[config.name] это мод для Тук-Тук Литературный Клуб, который не связан с Team Salvato."
        "В него рекомендуется играть только после завершения основной игры, и он содержит спойлеры из официальной игры."
        "Файлы для игры Тук Тук Литературный Клуб обязательно требуются, что работал этот мод, их можно скачать по адресу: http://ddlc.moe"
        menu:
            "Играя в [config.name] вы соглашаетесь что прошли Тук Тук Литературный Клуб, и готовы приянять любые спойлеры содержающиеся в моде."
            "Я подтверждаю.":
                pass
        scene tos2
        with Dissolve(1.5)
